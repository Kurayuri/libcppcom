...
public:
    ...
    void log_info(const nlohmann::json& message) {
        log(message, true, LEVEL::INFO);
    }
    
    void log_warning(const nlohmann::json& message) {
        log(message, true, LEVEL::WARNING);
    }
    
    void log_error(const nlohmann::json& message) {
        log(message, true, LEVEL::ERROR);
    }
